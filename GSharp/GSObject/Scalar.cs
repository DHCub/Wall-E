...
public class Scalar : GSObject
{
  ...
  public override bool GetTruthValue() => !Functions.EqualApprox(value, 0);
  ...
  public override GSObject OperateScalar(Scalar other, Div op)
      => Functions.EqualApprox(other.value, 0) ?
         throw new RuntimeError(null, "Zero Division Error", null) :
  ...
  public override GSObject OperateMeasure(Measure other, LessTh op) => new Scalar(Functions.LessThanApprox(Math.Abs(this.value), other.value));


  public override string ToString() => (this.value).ToString();

  public override bool Equals(GSObject obj) => obj is Scalar s && Functions.EqualApprox(s.value, this.value);
